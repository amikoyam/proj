#!/usr/bin/python3
# Subnet IP 2: Gateway 10.45.252.1 Subnet Mask 255.255.255.248
prefix = "10.45."
third = 252
nind = 0
...
for i in range(1,16):
    if nind > 255:
        third = third + 1
        nind = nind % 256
    print ("# RASP EMR Flexential 3 Floor 1 DataHall/Cage 1 Row 05 Aisle H Rack " + str(i) + " PDU")
    print ("# was RASP EMR Pod 1 Rack " + str(i) + " PDU 4U CC")
    ...
    print ('     include "/etc/dhcp/reservations/pod1-fl31ca105hr' + str(i).zfill(2) + '-pdu.conf";\n')
