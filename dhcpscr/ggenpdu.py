...
for i in range(1,16):
    if nind > 255:
        third = third + 1
        nind = nind % 256
    print ("# RASP EMR Flexential 3 Floor 1 DataHall/Cage 1 Row 05 Aisle G Rack " + str(i) + " PDU")
    ...
    print ('     include "/etc/dhcp/reservations/pod1-fl31ca105gr' + str(i).zfill(2) + '-pdu.conf";\n')
